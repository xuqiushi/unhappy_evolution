...
Unhappy::Unhappy(QWidget *parent)
    ...
    this->control_group_->addButton(this->parse_json_button_);
    this->head_h_layout_->addWidget(this->parse_json_button_);
    ...
    connect(this->parse_json_button_, &QPushButton::pressed, this, &Unhappy::changeActivePage);
    // 分配主布局上下比例
...
void Unhappy::changeActivePage() {
    ...
    } else if (button == this->parse_json_button_) {
        this->active_page_ = this->parse_json_;
    }
